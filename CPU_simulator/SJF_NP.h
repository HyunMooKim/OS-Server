...
void SJF_NP_Scheduling(Process* processes, int num_processes);
...
void SJF_NP_Scheduling(Process* processes, int num_processes) {
    ...
    //cpu_burst_time기준의 min 힙. waiting queue 자료구조 이용
    ...
    CalculateAverageTimes(processes, num_processes,2);
